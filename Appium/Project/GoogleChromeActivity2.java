...
public class GoogleChromeActivity2 {
	...
	@Test(priority = 1)
	public void loginPagewithCorrectCreds() throws InterruptedException   {
		...
		String UiScrollable = "UiScrollable(UiSelector().scrollable(true))";
		 ...
		 // Just scroll
        driver.findElement(AppiumBy.androidUIAutomator(UiScrollable + ".scrollForward(26)"));
     // Locate login page  element
	...
	@Test(priority = 2)
	public void loginPagewithIncorrCreds() throws InterruptedException   {
